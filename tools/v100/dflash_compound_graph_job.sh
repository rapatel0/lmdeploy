...
# The graph's stable-address contract currently requires direct-paged Q=8, so
# compare graph off/on with that prerequisite enabled in both arms.
set -euo pipefail
