...
private:
    ...
    mutable bool                         draft_attention_flattened_kv_replay_consumed_{};
    mutable bool                         draft_attention_core_replay_consumed_{};
    ...
    mutable bool                         layer0_mlp_gate_up_replay_consumed_{};
    ...
    mutable bool                         selector_input_replay_consumed_{};
    mutable bool                         selector_anchor_replay_consumed_{};
};
