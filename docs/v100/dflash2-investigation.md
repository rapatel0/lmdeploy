...
The next fidelity step is full downstream draft parity under exact post-communication context replay, locating the first equivalent mismatch after ProjectContext before another production change.
