...
The flat path is default-on for the exact SM70 ungrouped FP16 `5120x4120` shape. `TM_SM70_FP16_FLAT_GDN=0` retains the original row-major cuBLAS path; `=1` is the transposed-cuBLAS diagnostic control; `=2` explicitly selects the default native catalog. Only the winning 8x64x64 candidate is retained. Matrix: `/results/20260829_135435-dflash-fp16-flat-gdn-31d8741be859`; confirmation: `/results/20260829_140755-dflash-fp16-flat-gdn-followup`; identity: `/results/20260829_141145-dflash-fp16-flat-gdn-identity`.
