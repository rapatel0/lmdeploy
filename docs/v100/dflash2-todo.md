...
- [ ] **Optimize target verification kernels in measured order.**
  ...
  - Next inspect the 4.19 ms CUTLASS class and 3.86 ms recurrent kernel; do not repeat tile-only or scale-only exploration.
  - Draft attention is only about 0.62 ms/cycle and remains low priority. NCU artifacts: `/results/20260829_102845-dflash-fp8-m8-ncu-a546ab05061f`; scale-reuse artifacts: `/results/20260829_111237-dflash-fp8-m8-reuse-final-0d83abe6d2c8`; fused-decode artifact: `/results/20260829_114211-dflash-fp8-m8-fused-decode-64fa191aa854`.
