...
- [ ] **Optimize target verification kernels in measured order.**
  ...
  - [ ] Test SM70 Q=8 GDN value-column CTA decomposition. The baseline launches only 12 CTAs per layer. One-build V128/V64/V32/V16 arms preserve the K-lane reduction and every recurrent frontier while raising layer-level coverage to 12/24/48/96 CTAs. Require exact identity, at least 10% GDN kernel reduction, and at least 1% normalized-cycle gain.
